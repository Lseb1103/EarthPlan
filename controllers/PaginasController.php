...
class PaginasController {
    ...
    public static function contacto( Router $router ) {
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'e1c292e7464f36';
            $mail->Password = 'a45bab89dfa1be';
            $mail->SMTPSecure = 'tls';
            $mail->Port = 2525;

        
            $mail->setFrom('luissebastiancatota@gmail.com', $respuestas['nombre']);
            $mail->addAddress('luissebastiancatota@gmail.com', 'BienesRaices.com');
